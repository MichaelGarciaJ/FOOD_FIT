...
/**
 * Activity que muestra los platillos de categoría "Desayuno" disponibles para el usuario.
 */
class BreakfastActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ToolbarUtils.configurarDrawerToggle(
            binding.breakfastCustomToolbar,
            binding.breakfastDrawerLayout
        )
    ...
    /**
     * Método que carga solo los platillos de categoría "Desayuno"
